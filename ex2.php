<html>
 ...
 <body>
 	...
 	<?php
 		...
 		# Recogemos el valor del select en una variable
 		$Code = $_POST['Countries'];

 		# (2.1) creem el string de la consulta (query)
 		$consulta ="SELECT distinct(ci.Name) as City, co.Name as Country FROM city ci, country co WHERE ci.CountryCode='$Code' and co.Code=ci.CountryCode";
